...
class news extends model_base {
    ...
    public function process_auto() {
        $sql1 = "UPDATE ".PREFIX."_news_".$this->registry->sitelang." SET news_auto = '0' WHERE news_auto = '1' and news_date <= ".$this->registry->main_class->get_time();
        ...
        $sql2 = "UPDATE ".PREFIX."_news_".$this->registry->sitelang." SET news_status='0', news_term_expire=NULL, news_term_expire_action=NULL WHERE news_auto = '0' and news_term_expire <= '".$this->registry->main_class->get_time()."' AND news_term_expire_action = 'off'";
        $this->db->Execute($sql2);
        $num_result2 = $this->db->Affected_Rows();
        $sql3 = "DELETE FROM ".PREFIX."_news_".$this->registry->sitelang." WHERE news_auto = '0' and news_term_expire <= '".$this->registry->main_class->get_time()."' AND news_term_expire_action = 'delete'";
    ...
    public function index($num_page = false,$cat_id = false) {
        ...
        $sql = "SELECT count(a.news_id) FROM ".PREFIX."_news_".$this->registry->sitelang." a WHERE ".$input." and a.news_status = '1' and (".$sql_add.") and a.news_auto = '0'";
        $result = $this->db->Execute($sql);
        if($result) {
            $total_news = intval($result->fields['0']);
            $sql = "SELECT a.news_id,a.news_author,a.news_category_id,a.news_title,a.news_date,a.news_images,a.news_short_text,a.news_read_counter,a.news_notes,a.news_value_view,a.news_term_expire,a.news_term_expire_action,a.news_link, b.news_category_name FROM ".PREFIX."_news_".$this->registry->sitelang." a LEFT OUTER JOIN ".PREFIX."_news_categories_".$this->registry->sitelang." b on a.news_category_id=b.news_category_id WHERE ".$input." and a.news_status='1' and (".$sql_add.") and a.news_auto = '0' ORDER BY a.news_date DESC"; //LIMIT $offset, $num_news
    ...
    public function newsread($news_id,$num_page = false,$only_counter = false) {
        ...
        if($only_counter) {
            if($num_page == 1) {
                $sql0 = "UPDATE ".PREFIX."_news_".$this->registry->sitelang." SET news_read_counter=news_read_counter+1 WHERE news_auto = '0' and news_id = '".$news_id."'";
        ...
        $sql = "SELECT a.news_id,a.news_author,a.news_category_id,a.news_title,a.news_date,a.news_images,a.news_short_text,a.news_content,a.news_read_counter,a.news_notes,a.news_value_view,a.news_status,a.news_term_expire,a.news_term_expire_action,a.news_on_home,a.news_link, b.news_category_name FROM ".PREFIX."_news_".$this->registry->sitelang." a LEFT OUTER JOIN ".PREFIX."_news_categories_".$this->registry->sitelang." b on a.news_category_id=b.news_category_id WHERE a.news_id='".$news_id."' and news_auto = '0' and (".$sql_add.")";
        $result = $this->db->Execute($sql);
        if(!$result) {
