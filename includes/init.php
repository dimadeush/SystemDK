...
if (file_exists(__SITE_PATH . "/themes/" . SITE_THEME . "/" . SITE_THEME . ".php")) {
    ...
    echo "<html><header><title>SystemDK - Fatal Error</title></header><body><br><br><center>Fatal error<br><br>SystemDK can't find theme file: " . __SITE_PATH
         . "/themes/" . SITE_THEME . "/" . SITE_THEME . ".php</center></body></html>";
    exit();
}
