...
class admin_administrator extends model_base {
    ...
    public function mainadmin_edit_inbase($post_array) {
        ...
        if((!isset($post_array['admin_edit_name']) or !isset($post_array['admin_edit_surname'])or !isset($post_array['admin_edit_website']) or !isset($post_array['admin_edit_email']) or !isset($post_array['admin_edit_newpassword']) or !isset($post_array['admin_edit_newpassword2']) or !isset($post_array['admin_edit_country']) or !isset($post_array['admin_edit_city']) or !isset($post_array['admin_edit_address']) or !isset($post_array['admin_edit_telephone']) or !isset($post_array['admin_edit_icq']) or !isset($post_array['admin_edit_skype']) or !isset($post_array['admin_edit_gmt']) or !isset($post_array['admin_edit_notes']) or !isset($post_array['admin_edit_viewemail'])) or ($data_array['admin_edit_email'] == "" or $data_array['admin_edit_gmt'] == "")) {
        ...
        if(!empty($data_array['admin_edit_newpassword'])) {
            ...
            if($data_array['admin_edit_newpassword'] !== $data_array['admin_edit_newpassword2'] or $data_array['admin_edit_newpassword'] == "") {
                ...
                if($result0) {
                    ...
                    if($row_exist == 0) {
                        ...
                        $sql = "UPDATE ".PREFIX."_users SET user_name = ".$data_array['admin_edit_name'].",user_surname = ".$data_array['admin_edit_surname'].",user_website = ".$data_array['admin_edit_website'].",user_email = ".$data_array['admin_edit_email'].",user_password = '".$data_array['admin_edit_password']."',user_country = ".$data_array['admin_edit_country'].",user_city = ".$data_array['admin_edit_city'].",user_address = ".$data_array['admin_edit_address'].",user_telephone = ".$data_array['admin_edit_telephone'].",user_icq = ".$data_array['admin_edit_icq'].",user_skype = ".$data_array['admin_edit_skype'].",user_gmt = ".$data_array['admin_edit_gmt'].",user_notes = ".$data_array['admin_edit_notes'].",user_view_email = '".$data_array['admin_edit_viewemail']."' WHERE user_id = '".$admin_edit_id."'";
            ...
            if($result0) {
                ...
                if($row_exist == 0) {
                    $sql = "UPDATE ".PREFIX."_users SET user_name = ".$data_array['admin_edit_name'].",user_surname = ".$data_array['admin_edit_surname'].",user_website = ".$data_array['admin_edit_website'].",user_email = ".$data_array['admin_edit_email'].",user_country = ".$data_array['admin_edit_country'].",user_city = ".$data_array['admin_edit_city'].",user_address = ".$data_array['admin_edit_address'].",user_telephone = ".$data_array['admin_edit_telephone'].",user_icq = ".$data_array['admin_edit_icq'].",user_skype = ".$data_array['admin_edit_skype'].",user_gmt = ".$data_array['admin_edit_gmt'].",user_notes = ".$data_array['admin_edit_notes'].",user_view_email = '".$data_array['admin_edit_viewemail']."' WHERE user_id = '".$admin_edit_id."'";
                    $insert_result = $this->db->Execute($sql);
                    $num_result = $this->db->Affected_Rows();
                    if($insert_result === false) {
                        $error_message = $this->db->ErrorMsg();
