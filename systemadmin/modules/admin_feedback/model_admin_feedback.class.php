...
class admin_feedback extends model_base {
    ...
    public function index($num_page) {
        ...
        if($result) {
            ...
            $sql = "SELECT receiver_id,receiver_name,receiver_email,receiver_active FROM ".PREFIX."_mail_receivers_".$this->registry->sitelang." order by receiver_id DESC";
    ...
    public function feedback_add_inbase($array) {
        ...
        if((!isset($array['receiver_name']) or !isset($array['receiver_email']) or !isset($array['receiver_active'])) or ($data_array['receiver_name'] == "" or $data_array['receiver_email'] == "")) {
        ...
        $sql = "INSERT INTO ".PREFIX."_mail_receivers_".$this->registry->sitelang." (".$sequence_array['field_name_string']."receiver_name,receiver_email,receiver_active) VALUES (".$sequence_array['sequence_value_string']."".$data_array['receiver_name'].",".$data_array['receiver_email'].",'".$data_array['receiver_active']."')";
        $result = $this->db->Execute($sql);
        if($result === false) {
            $error_message = $this->db->ErrorMsg();
            $error_code = $this->db->ErrorNo();
    ...
    public function feedback_edit_inbase($array) {
        ...
        if((!isset($array['receiver_id']) or !isset($array['receiver_name']) or !isset($array['receiver_email']) or !isset($array['receiver_active'])) or ($data_array['receiver_id'] == 0 or $data_array['receiver_name'] == "" or $data_array['receiver_email'] == "")) {
        ...
        $data_array['receiver_email'] = $this->registry->main_class->processing_data($data_array['receiver_email']);
        $sql = "UPDATE ".PREFIX."_mail_receivers_".$this->registry->sitelang." SET receiver_name = ".$data_array['receiver_name'].", receiver_email = ".$data_array['receiver_email'].", receiver_active = '".$data_array['receiver_active']."' WHERE receiver_id = '".$data_array['receiver_id']."'";
        $result = $this->db->Execute($sql);
    ...
    public function feedback_status($array) {
        ...
        if((!isset($array['action'])) or ($data_array['action'] == "" or $data_array['receiver_id'] == 0)) {
        ...
        if($data_array['action'] == "on") {
            $sql = "UPDATE ".PREFIX."_mail_receivers_".$this->registry->sitelang." SET receiver_active = '1' WHERE receiver_id = '".$data_array['receiver_id']."'";
            $result = $this->db->Execute($sql);
        } elseif($data_array['action'] == "off") {
            $sql = "UPDATE ".PREFIX."_mail_receivers_".$this->registry->sitelang." SET receiver_active = '0' WHERE receiver_id = '".$data_array['receiver_id']."'";
            $result = $this->db->Execute($sql);
