...
class admin_users extends model_base
{
    ...
    public function index($num_page = false, $temp = false, $admin = false)
    {
        ...
        if ($result) {
            ...
            $sql = "SELECT user_id,user_name,user_surname,user_login,user_rights,user_email,user_active,user_reg_date FROM " . PREFIX . "_users " . $where
    ...
    public function user_add($admin = false)
    {
        ...
        $this->error = false;
        $this->error_array = false;
        if ($admin && $this->registry->main_class->get_user_rights() !== "main_admin") {
    ...
    public function user_add_inbase($post_array)
    {
        ...
        if ((!isset($post_array[$prefix . '_add_name']) || !isset($post_array[$prefix . '_add_surname']) || !isset($post_array[$prefix . '_add_website'])
             || !isset($post_array[$prefix . '_add_email'])
             || !isset($post_array[$prefix . '_add_login'])
             || !isset($post_array[$prefix . '_add_password'])
             || !isset($post_array[$prefix . '_add_password2'])
             || !isset($post_array[$prefix . '_add_country'])
             || !isset($post_array[$prefix . '_add_city'])
             || !isset($post_array[$prefix . '_add_address'])
             || !isset($post_array[$prefix . '_add_telephone'])
             || !isset($post_array[$prefix . '_add_icq'])
             || !isset($post_array[$prefix . '_add_skype'])
             || !isset($post_array[$prefix . '_add_gmt'])
             || !isset($post_array[$prefix . '_add_notes'])
             || !isset($post_array[$prefix . '_add_active'])
             || !isset($post_array[$prefix . '_add_activenotes'])
             || !isset($post_array[$prefix . '_add_viewemail']))
            || ($data_array[$prefix . '_add_email'] == "" || $data_array[$prefix . '_add_login'] == "" || $data_array[$prefix . '_add_password'] == ""
                || $data_array[$prefix . '_add_password2'] == ""
                || $data_array[$prefix . '_add_gmt'] == "")
        ) {
        ...
        if (preg_match("/[^a-zA-Zа-яА-Я0-9_-]/", $data_array[$prefix . '_add_login'])) {
        ...
        if ($data_array[$prefix . '_add_password'] !== $data_array[$prefix . '_add_password2']) {
            ...
            $sql0 = "SELECT count(*) as count FROM " . PREFIX . "_users WHERE user_email = " . $data_array[$prefix . '_add_email'] . " or user_login = "
                    . $data_array[$prefix . '_add_login'];
            ...
            if ($insert_result) {
                ...
                if ($num_rows == 0) {
                    ...
                    $sql = "INSERT INTO " . PREFIX . "_users (" . $sequence_array['field_name_string']
                           ...
                           . $sequence_array['sequence_value_string'] . "'0'," . $data_array[$prefix . '_add_name'] . "," . $data_array[$prefix . '_add_surname'] . ","
                           . $data_array[$prefix . '_add_website'] . "," . $data_array[$prefix . '_add_email'] . "," . $data_array[$prefix . '_add_login'] . ",'"
                           . $data_array[$prefix . '_add_password'] . "',null,null,'" . $data_array[$prefix . '_add_rights'] . "'," . $data_array[$prefix
                                                                                                                                                  . '_add_country']
                           . "," . $data_array[$prefix . '_add_city'] . "," . $data_array[$prefix . '_add_address'] . "," . $data_array[$prefix . '_add_telephone'] . ","
                           . $data_array[$prefix . '_add_icq'] . "," . $data_array[$prefix . '_add_skype'] . "," . $data_array[$prefix . '_add_gmt'] . ","
                           . $data_array[$prefix . '_add_notes'] . ",'" . $data_array[$prefix . '_add_active'] . "'," . $data_array[$prefix . '_add_activenotes'] . ",'"
                           . $now . "',null,'" . $data_array[$prefix . '_add_viewemail'] . "',null,null,null)";
    ...
    public function user_status($array)
    {
        ...
        if ($user_id == 0 && isset($array['post_user_id']) && is_array($array['post_user_id']) && count($array['post_user_id']) > 0) {
            $user_id_is_arr = 1;
        ...
        if (!isset($user_id) || $action == "" || ($user_id == "'0'" && $action != "deletetempall")) {
        ...
        if ($action == "on") {
            ...
            $result = $this->db->Execute($sql);
        } elseif ($action == "deletetemp" && !isset($array['admin'])) {
            $sql = "DELETE FROM " . PREFIX . "_users WHERE user_id IN (" . $user_id . ") and user_temp = '1' " . $where;
            $result = $this->db->Execute($sql);
        } elseif ($action == "deletetempall" && !isset($array['admin'])) {
        ...
        if ($result === false) {
            ...
            if ($action == "deletetemp" || $action == "deletetempall") {
    ...
    public function user_edit($array)
    {
        ...
        if (isset($array['admin'])) {
            if ($this->registry->main_class->get_user_rights() !== "main_admin" && isset($array['user_id'])
                && intval($this->registry->main_class->get_user_id()) != intval($array['user_id'])
            ) {
        ...
        if (!isset($array['user_id']) || $user_id == 0) {
            $this->error = 'empty_data';
        ...
        if ($result) {
            if (isset($result['0']) && isset($result['6'])
                && ((!isset($array['admin']) && $this->registry->main_class->extracting_data($result['6']) === 'user')
                    || (isset($array['admin'])
                        && ($this->registry->main_class->extracting_data($result['6']) === 'admin'
                            || $this->registry->main_class->extracting_data(
                                $result['6']
                            ) === 'main_admin')))
            ) {
    ...
    public function user_edit_inbase($post_array)
    {
        ...
        if (isset($post_array['admin'])) {
            if ($this->registry->main_class->get_user_rights() !== "main_admin" && isset($post_array[$prefix . '_edit_id'])
                && intval(
                       $this->registry->main_class->get_user_id()
                   ) != intval($post_array[$prefix . '_edit_id'])
            ) {
                $this->error = 'edit_rights';
        ...
        if ((!isset($post_array[$prefix . '_edit_id']) || !isset($post_array[$prefix . '_edit_name']) || !isset($post_array[$prefix . '_edit_surname'])
             || !isset($post_array[$prefix . '_edit_website'])
             || !isset($post_array[$prefix . '_edit_email'])
             || !isset($post_array[$prefix . '_edit_login'])
             || !isset($post_array[$prefix . '_edit_newpassword'])
             || !isset($post_array[$prefix . '_edit_newpassword2'])
             || !isset($post_array[$prefix . '_edit_country'])
             || !isset($post_array[$prefix . '_edit_city'])
             || !isset($post_array[$prefix . '_edit_address'])
             || !isset($post_array[$prefix . '_edit_telephone'])
             || !isset($post_array[$prefix . '_edit_icq'])
             || !isset($post_array[$prefix . '_edit_skype'])
             || !isset($post_array[$prefix . '_edit_gmt'])
             || !isset($post_array[$prefix . '_edit_notes'])
             || !isset($post_array[$prefix . '_edit_active'])
             || !isset($post_array[$prefix . '_edit_activenotes'])
             || !isset($post_array[$prefix . '_edit_viewemail']))
            || ($data_array[$prefix . '_edit_id'] == 0 || $data_array[$prefix . '_edit_email'] == "" || $data_array[$prefix . '_edit_login'] == ""
                || $data_array[$prefix . '_edit_gmt'] == "")
        ) {
        ...
        if (isset($post_array['admin']) && $this->registry->main_class->get_user_id() == $data_array[$prefix . '_edit_id']
            && $data_array[$prefix . '_edit_active'] == 0
        ) {
        ...
        if (preg_match("/[^a-zA-Zа-яА-Я0-9_-]/", $data_array[$prefix . '_edit_login'])) {
        ...
        $sql_add = false;
        if (isset($data_array[$prefix . '_edit_newpassword']) && $data_array[$prefix . '_edit_newpassword'] != "") {
            ...
            if ($data_array[$prefix . '_edit_newpassword'] !== $data_array[$prefix . '_edit_newpassword2']) {
                ...
                $sql_add = "user_password = '" . crypt($data_array[$prefix . '_edit_newpassword'], $this->registry->main_class->salt())
                           . "',user_session_code = null,user_session_agent = null,";
            }
        }
        $sql0 = "SELECT a.user_login, (SELECT max(b.user_id) FROM " . PREFIX . "_users b WHERE b.user_id <> '" . $data_array[$prefix . '_edit_id']
                . "' and (b.user_email=" . $data_array[$prefix . '_edit_email'] . " or b.user_login=" . $data_array[$prefix . '_edit_login'] . ")) as num_rows FROM "
                . PREFIX . "_users a WHERE a.user_id = '" . $data_array[$prefix . '_edit_id'] . "'";
        $insert_result = $this->db->Execute($sql0);
        if ($insert_result) {
            ...
            if ($data_array[$prefix . '_old_login'] !== substr(substr($data_array[$prefix . '_edit_login'], 0, -1), 1) && empty($sql_add)) {
            ...
            $sql = "UPDATE " . PREFIX . "_users SET user_name = " . $data_array[$prefix . '_edit_name'] . ",user_surname = " . $data_array[$prefix . '_edit_surname']
                   . ",user_website = " . $data_array[$prefix . '_edit_website'] . ",user_email = " . $data_array[$prefix . '_edit_email']
                   . ",user_login = " . $data_array[$prefix . '_edit_login'] . "," . $sql_add . "user_country = " . $data_array[$prefix . '_edit_country']
                   . ",user_city = "
                   . $data_array[$prefix . '_edit_city'] . ",user_address = " . $data_array[$prefix . '_edit_address'] . ",user_telephone = " . $data_array[$prefix
                                                                                                                                                            . '_edit_telephone']
                   . ",user_icq = " . $data_array[$prefix . '_edit_icq'] . ",user_skype = " . $data_array[$prefix . '_edit_skype'] . ",user_gmt = "
                   . $data_array[$prefix . '_edit_gmt'] . ",user_notes = " . $data_array[$prefix . '_edit_notes'] . ",user_active = '" . $data_array[$prefix
                                                                                                                                                     . '_edit_active']
                   . "',user_active_notes = " . $data_array[$prefix . '_edit_activenotes'] . ",user_view_email = '" . $data_array[$prefix . '_edit_viewemail']
                   . "' WHERE user_id = '" . $data_array[$prefix . '_edit_id'] . "' and user_temp = '0' and " . $where;
            $insert_result = $this->db->Execute($sql);
            $num_result = $this->db->Affected_Rows();
            if ($insert_result === false) {
                $error_message = $this->db->ErrorMsg();
                ...
                if ($num_result > 0 && $data_array[$prefix . '_old_login'] !== $data_array[$prefix . '_edit_login']) {
                    ...
                    for ($i = 0, $size = sizeof($clear_langlist); $i < $size; ++$i) {
                        $sql = "UPDATE " . PREFIX . "_main_pages_" . $clear_langlist[$i]['name'] . " SET main_page_author = '" . $data_array[$prefix . '_edit_login']
                               . "' WHERE main_page_author = '" . $data_array[$prefix . '_old_login'] . "'";
                        ...
                        $sql = "UPDATE " . PREFIX . "_messages_" . $clear_langlist[$i]['name'] . " SET message_author = '" . $data_array[$prefix . '_edit_login']
                               . "' WHERE message_author = '" . $data_array[$prefix . '_old_login'] . "'";
                        ...
                        $sql = "UPDATE " . PREFIX . "_news_" . $clear_langlist[$i]['name'] . " SET news_author = '" . $data_array[$prefix . '_edit_login']
                               . "' WHERE news_author = '" . $data_array[$prefix . '_old_login'] . "'";
                ...
                if ($data_array[$prefix . '_edit_id'] == $this->registry->main_class->get_user_id() && $insert_result !== false && !empty($sql_add)) {
