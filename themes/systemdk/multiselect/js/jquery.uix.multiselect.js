        ...
        reIndex: function() {
            ...
            if (comparator) {
                ...
                this._elements.sort(function(a, b) {
                    ...
                    // fix for correct order start
                    if(a.optionElement.attr('label') && a.optionElement.attr('label').length > 0 && a.optionElement.attr('selected')) {
                        var order_data1 = a.optionElement.attr('label');
                    } else {
                        var order_data1 = a.optionElement.text();
                    }
                    if(b.optionElement.attr('label') && b.optionElement.attr('label').length > 0 && b.optionElement.attr('selected')) {
                        var order_data2 = b.optionElement.attr('label');
                    } else {
                        var order_data2 = b.optionElement.text();
                    }
                    //fix for correct order end

                    if (g != 0) return g;
                    else        return comparator(order_data1, order_data2);
                });
            }
